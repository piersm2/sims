-- Add filament_usage_amount to product_filaments
ALTER TABLE product_filaments ADD COLUMN filament_usage_amount REAL DEFAULT 0;

-- Drop and recreate the view with usage-based minimum quantity calculation
...
SELECT 
    ...
    CASE 
        ...
        ELSE MIN(8, 2 + SUM(pf.filament_usage_amount) / 1000)  -- Convert grams to kg and cap at 8 spools
...
INSERT OR IGNORE INTO schema_versions (version) VALUES (38); 