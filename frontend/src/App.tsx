    ...
    <div className="min-h-screen bg-white p-8 font-mono">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col space-y-4">
          <div className="flex items-center justify-between bg-black border-2 border-black p-4">
            ...
            <button
              ...
              className="px-4 py-2 border border-black rounded-none text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-1 focus:ring-black transition-colors uppercase tracking-wider"
            >
              NEW RECORD
            </button>
          </div>
